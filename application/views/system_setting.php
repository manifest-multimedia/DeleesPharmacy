					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<p> You need additional license to enable custom branding for your SmartPOS Solution </p> 
								<input type="hidden" name="site_name" class="form-control" placeholder="Site Name" maxlength="499" autofocus required value="<?php echo $site_name; ?>" autocomplete="off" />
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<br />
								<input type="hidden" id="uploadFile" readonly style="height: 40px; width: 230px; border: 1px solid #ccc" />
								<!-- <div class="fileUpload btn btn-primary" style="padding: 9px 12px;"> -->
								    <span><?php //echo $lang_browse; ?> Buy Custom Branding License to change the Logo of your SmartPOS solution.</span>
								    <input type="hidden" id="uploadBtn" name="uploadFile" type="file" class="upload" />
								</div>
							</div>
