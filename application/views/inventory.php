...
<!-- Add fancyBox -->
<link rel="stylesheet" href="<?=base_url()?>assets/js/fancybox/source/jquery.fancybox.css?v=2.1.5" type="text/css"
	media="screen" />
<script type="text/javascript" src="<?=base_url()?>assets/js/fancybox/source/jquery.fancybox.pack.js?v=2.1.5"></script>

<!-- Optionally add helpers - button, thumbnail and/or media -->
<link rel="stylesheet" href="<?=base_url()?>assets/js/fancybox/source/helpers/jquery.fancybox-buttons.css?v=1.0.5"
	type="text/css" media="screen" />
<script type="text/javascript"
	src="<?=base_url()?>assets/js/fancybox/source/helpers/jquery.fancybox-buttons.js?v=1.0.5"></script>
<script type="text/javascript" src="<?=base_url()?>assets/js/fancybox/source/helpers/jquery.fancybox-media.js?v=1.0.6">
</script>

<link rel="stylesheet" href="<?=base_url()?>assets/js/fancybox/source/helpers/jquery.fancybox-thumbs.css?v=1.0.7"
	type="text/css" media="screen" />
<script type="text/javascript" src="<?=base_url()?>assets/js/fancybox/source/helpers/jquery.fancybox-thumbs.js?v=1.0.7">
</script>
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-body">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<button class="btn btn-primary"
										style="width: 100%;">&nbsp;&nbsp;<?php echo $lang_search; ?>&nbsp;&nbsp;</button>
								</div>
							</div>
						</div>
					</form>
								...
								<table class="table">
                                    ...
                                    if (count($results) > 0) {
                                        ...
                                        foreach ($results as $data) {
                                            ...
                                            $each_cost = 0;
                                            $each_price = 0;
                                            $getCostResult = $this->db->query("SELECT purchase_price, retail_price FROM products WHERE code = '$code' ");
                                            $getCostData = $getCostResult->result();

                                            $each_cost = $getCostData[0]->purchase_price;
                                            $each_price = $getCostData[0]->retail_price;
                                            ...
                                            $each_row_cost = $inv_qty * $each_cost; 
																						$each_row_price = $inv_qty * $each_price; 
										...
										<tr>
											...
											<td><?php echo number_format($each_row_price, 2, '.', ','); ?></td>
											<!-- <td><?php echo number_format($each_row_cost, 2, '.', ''); ?></td> -->
											<td>
					...
					$prodResult = $this->db->query("SELECT * FROM products");
			...
			foreach ($prodData as $data) {
					...
					$total_stock_qty += $inv_qty;
					$total_cost_amt += $each_row_cost;
					$total_price_amt += $each_row_price;
					$total_profit = ($total_price_amt - $total_cost_amt);
					} 
					?>

					<div class="row"
						style="padding-top: 10px; padding-bottom: 10px; margin-top: 50px; font-size: 18px; letter-spacing: 0.5px; border-top: 1px solid #ddd;">
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px; font-size: 18px; letter-spacing: 0.5px; ">
						<div class="col-md-3" style="font-weight: bold;">Total Cost Value (<?php echo $site_currency; ?>)</div>
						<div class="col-md-9" style="font-weight: bold;">:
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px; font-size: 18px; letter-spacing: 0.5px; ">
						<div class="col-md-3" style="font-weight: bold;">Total Price Value (<?php echo $site_currency; ?>)</div>
						<div class="col-md-9" style="font-weight: bold;">:
							<?php echo number_format($total_price_amt, 2, '.', ','); ?>
						</div>
					</div>

					<div class="row" style="padding-top: 10px; padding-bottom: 10px; font-size: 18px; letter-spacing: 0.5px; ">
						<div class="col-md-3" style="font-weight: bold;">Total Profit (<?php echo $site_currency; ?>)</div>
						<div class="col-md-9" style="font-weight: bold;">:
