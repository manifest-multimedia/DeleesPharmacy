											...
											<div class="regular slider" style="width: 100%">
												...
												<?php
                                                    ...
                                                    for ($ct = 0; $ct < count($catData); ++$ct) {
														...
														<div data-toggle="tab" href="#pilltab<?php echo $cat_id; ?>" style="cursor: pointer; text-align: center; background-color: #373942; color: #FFF; width: 200px; height: 50px; text-align: center; vertical-align: middle; line-height: 50px;">
													      	<?php echo $cat_name; ?>
													    </div>
