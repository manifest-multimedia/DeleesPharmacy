...
<div id="wrapper">
    ...
    <table class="table" cellspacing="0"  border="0"> 
        ...
        $orderItemResult = $this->db->query("SELECT * FROM order_items WHERE order_id = '$id' ORDER BY product_name ");
    ...
    public function loadCustomer()
    {
        ...
        $getLastCustResult = $this->db->query('SELECT * FROM customers ORDER BY fullname ASC LIMIT 0,1');
