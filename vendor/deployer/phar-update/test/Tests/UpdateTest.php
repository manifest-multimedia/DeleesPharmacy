...
namespace Deployer\Component\PharUpdate\Tests;
...
PUBLIC
    ...
    public function testCopyToNotDownloaded()
    {
        $this->setExpectedException(
            'Deployer\\Component\\PharUpdate\\Exception\\LogicException',
    ...
    public function testCopyToCopyError()
    {
        ...
        $this->setExpectedException(
            'Deployer\\Component\\PharUpdate\\Exception\\FileException',
